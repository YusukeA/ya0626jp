/*Light Box*/
    $(document).ready(function(){
        ...
        $("figure#img14").click(function(){
            $("#BlackWindow, #lightbox-panel14").fadeIn(300);
         })
         
        $("figure#img15").click(function(){
            $("#BlackWindow, #lightbox-panel15").fadeIn(300);
         })
         
        $("figure#img16").click(function(){
